        ...
        <form method="post" class="container-fluid" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-4 col-lg-6">
                    ...
                    <input type="text" name="firstname" value="<?php echo $firstname=$_SESSION['firstname'];?>">
                </div>
                <div class="col-xs-12 col-md-4 col-lg-6">
                    <label class="last">Last: </label>
                    <input type="text" name="lastname" value="<?php echo $lastname=$_SESSION['lastname'];?>">
                </div>
            </div>
            <label class="email">E-mail: </label>
            <input type="text" name="email" value="<?php echo $email=$_SESSION['email'];?>"><font color="red" size="3">*</font><?php echo $emailErr;?>
                ...
                <div class="col-xs-12 col-md-20">
                    <label>
                        ...
                        <input type="radio" name="skin" value="Tan"
                               <?php if (isset($skin) && $skin=="tan") echo "checked";?>
                               value="tan">
                        Tan
                    </label>
                </div>
                <div class="col-xs-12 col-md-20">
                    <label>
                        ...
                        <input type="radio" name="skin" value="Medium"
                               <?php if (isset($skin) && $skin=="medium") echo "checked";?>
                               value="medium">
                        Medium
                    </label>
                </div>
                <div class="col-xs-12 col-md-20">
                    <label>
                        ...
                        <input type="radio" name="skin" value="Light"
                               <?php if (isset($skin) && $skin=="light") echo "checked";?>
                               value="light">
                        Light
                    </label>
                </div>
                <div class="col-xs-12 col-md-20">
                    <label>
                        ...
                        <input type="radio" name="skin" value="Ivory"
                               <?php if (isset($skin) && $skin=="ivory") echo "checked";?>
                               value="ivory">
                        Ivory
                    </label>
                </div>
